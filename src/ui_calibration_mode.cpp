...
void UIIntrinsicsCalibrationMode::getCalibIntrinsicsMenuList (std::vector<std::string>& menuList)
{
    menuList.clear();
...
void UIExtrinsicsCalibrationMode::getCalibExtrinsicsMenuList (std::vector<std::string>& menuList)
{
    menuList.clear();
